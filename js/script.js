...
$( document ).ready(function() {
	...
	function Pong() {
		this.height = 18;
		this.distanceFromBottom = 10;
		this.width = 100;
		this.posX = canvasSize / 2 - this.width/2;
		this.posY = canvasSize - this.height - this.distanceFromBottom;
		this.color = 'yellow';
		this.acc = 0.5;
		this.dec = 0.25;
		this.speed = 0;
		...
		this.makeAstep = function() {
			...
			if(!isLeft && !isRight && this.speed !== 0) {
		...
		this.checkBoundaries = function() {
			...
			if(this.posX + this.width + this.speed > canvasSize) {
	...
	function Ball() {
		...
		this.makeAstep = function() {
			...
			} else if (/*this.posY + this.size > canvasSize ||*/ this.posY - this.size < 0) {
	...
	function checkPing() {
		if(circleRect(ball, board)) {
			//console.log(ball.posX, board.posX, CalcPrecent(ball.posX, board.posX, board.posX + board.width));
